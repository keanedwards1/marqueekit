...
export default function PricingPage() {
  ...
  return (
    <>
      <Head
        title="MarqueeKit - Pricing Plans for High-Performance Image Marquees"
        description="Explore MarqueeKit's pricing plans for seamless, customizable image marquees. One-time payment options with lifetime updates and no subscription needed."
        url="https://marqueekit.com/pricing"
        image="https://marqueekit.com/favicon-96x96.png"
        type="website"
        locale="en_US"
        author="Kean"
        keywords="MarqueeKit, pricing, image marquee plans, website marquee pricing, seamless marquee, developer tools for web design"
        themeColor="#ffffff"
